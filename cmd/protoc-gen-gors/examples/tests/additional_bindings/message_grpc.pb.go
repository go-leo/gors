...
const (
	Messaging2_UpdateMessage_FullMethodName = "/tests.additional_bindings.message.v1.Messaging2/UpdateMessage"
)
...
var Messaging2_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tests.additional_bindings.message.v1.Messaging2",
