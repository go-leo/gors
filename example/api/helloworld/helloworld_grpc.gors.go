...
func GreeterClientRoutes(cli GreeterClient, opts ...gors.Option) []gors.Route {
	...
	return []gors.Route{
		...
		gors.NewRoute(
			...
			func(c *gin.Context) {
				var rpcMethodName = "/helloworld.Greeter/POSTSetHeaderTrailer"
				var ctx = gors.NewContext(c, rpcMethodName)
				var req *HelloRequest
				var resp *HelloReply
				var err error
		...
		gors.NewRoute(
			...
			"/v1/Error",
			func(c *gin.Context) {
				var rpcMethodName = "/helloworld.Greeter/POSTError"
				var ctx = gors.NewContext(c, rpcMethodName)
				var req *HelloRequest
				var resp *HelloReply
				var err error
		...
		gors.NewRoute(
			...
			"/v1/GRPCStatus",
			func(c *gin.Context) {
				var rpcMethodName = "/helloworld.Greeter/POSTGRPCStatus"
				var ctx = gors.NewContext(c, rpcMethodName)
				var req *HelloRequest
				var resp *HelloReply
				var err error
