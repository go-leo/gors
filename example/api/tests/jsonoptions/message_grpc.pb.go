...
const (
	Messaging_CreateMessage_FullMethodName = "/tests.jsonnames.message.v1.Messaging/CreateMessage"
	Messaging_UpdateMessage_FullMethodName = "/tests.jsonnames.message.v1.Messaging/UpdateMessage"
)
...
type MessagingClient interface {
	...
	UpdateMessage(ctx context.Context, in *Message2, opts ...grpc.CallOption) (*Message2, error)
}
...
func (c *messagingClient) UpdateMessage(ctx context.Context, in *Message2, opts ...grpc.CallOption) (*Message2, error) {
	out := new(Message2)
...
func (UnimplementedMessagingServer) UpdateMessage(context.Context, *Message2) (*Message2, error) {
...
func _Messaging_UpdateMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessagingServer).UpdateMessage(ctx, req.(*Message2))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Messaging_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tests.jsonnames.message.v1.Messaging",
	...
	Metadata: "cmd/protoc-gen-gors/examples/tests/jsonoptions/message.proto",
}
