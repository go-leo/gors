...
func MessagingServiceRoutes(svc MessagingService, opts ...gors.Option) []gors.Route {
	...
	return []gors.Route{
		...
		gors.NewRoute("PATCH", "/v1/messages", _Messaging_UpdateMessage_GORS_Handler(wrapper, options, _Messaging_UpdateMessage_GORS_Handler_PATCH_46cfd5872c02a89afb8c3f6fac56cbf9_Binding())),
	}
}
...
func _Messaging_UpdateMessage_GORS_Handler_PATCH_46cfd5872c02a89afb8c3f6fac56cbf9_Binding() *binding.HttpRuleBinding {
	return &binding.HttpRuleBinding{
		Body: &binding.BodyRule{
			Name: "*",
			Type: "object",
