...
var file_example_api_tests_example_message_proto_rawDesc = []byte{
	...
	0x0a, 0x06, 0x5f, 0x6d, 0x61, 0x79, 0x62, 0x65, 0x32, 0x8e, 0x06, 0x0a, 0x09, 0x4d, 0x65, 0x73,
	...
	0x64, 0x7d, 0x12, 0x57, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x21, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2e, 0x65, 0x78, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
	...
	0x31, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x28, 0x01, 0x12, 0x58, 0x0a, 0x0e, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x2e,
	0x74, 0x65, 0x73, 0x74, 0x73, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x1a, 0x21, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
	0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x30, 0x01, 0x12, 0x52, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12,
	...
	0x67, 0x65, 0x1a, 0x21, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x73, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70,
	0x6c, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74,
	...
	0x74, 0x65, 0x73, 0x74, 0x73, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x76, 0x31,
...
var file_example_api_tests_example_message_proto_depIdxs = []int32{
	...
	1, // 5: tests.example.message.v1.Messaging.StreamRequest:input_type -> tests.example.message.v1.Message
	1, // 6: tests.example.message.v1.Messaging.StreamResponse:input_type -> tests.example.message.v1.Message
	1, // 7: tests.example.message.v1.Messaging.Stream:input_type -> tests.example.message.v1.Message
	1, // 8: tests.example.message.v1.Messaging.GetMessages:output_type -> tests.example.message.v1.Message
	1, // 9: tests.example.message.v1.Messaging.GetMessage:output_type -> tests.example.message.v1.Message
	1, // 10: tests.example.message.v1.Messaging.CreateMessage:output_type -> tests.example.message.v1.Message
	1, // 11: tests.example.message.v1.Messaging.UpdateMessage:output_type -> tests.example.message.v1.Message
	1, // 12: tests.example.message.v1.Messaging.StreamRequest:output_type -> tests.example.message.v1.Message
	1, // 13: tests.example.message.v1.Messaging.StreamResponse:output_type -> tests.example.message.v1.Message
	1, // 14: tests.example.message.v1.Messaging.Stream:output_type -> tests.example.message.v1.Message
